...
VALUES ('DISABLE ALERTS', FALSE),
       ('DISABLE NOTIFICATIONS', FALSE),
       ('INFORMATIONAL ALERTS', TRUE),
       ('ERROR ALERTS', TRUE),
       ('CONFIRMATION ALERTS', TRUE),
       ('WARNING ALERTS', TRUE),
       ('INFORMATION NOTIFICATIONS', TRUE),
       ('ERROR NOTIFICATIONS', TRUE),
       ('CONFIRMATION NOTIFICATIONS', TRUE),
       ('WARNING NOTIFICATIONS', TRUE);
