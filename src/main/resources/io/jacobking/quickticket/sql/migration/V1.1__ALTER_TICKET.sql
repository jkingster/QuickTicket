...
(
    ...
    ATTACHED_JOURNAL_ID   INTEGER  NOT NULL REFERENCES JOURNAL (ID)
);

INSERT OR IGNORE INTO NEW_TICKET(ID, TITLE, STATUS, PRIORITY, CREATED_ON, EMPLOYEE_ID, LAST_OPENED_TIMESTAMP, ATTACHED_JOURNAL_ID)
SELECT ID,
       TITLE,
       STATUS,
       PRIORITY,
